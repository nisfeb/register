...
::  organizer edits any of them on the page itself. A string may carry
::  [text](https://host/path), which the page renders as a link.
::
++  starter-copy
  ^-  json
  %-  pairs:enjs:format
  :~  ['landing.title' s+'Register for the Baby Steps Camino']
      ['landing.intro' s+'Three days of beach walking, prayer and fellowship from Jacksonville Beach to the Shrine of Our Lady of La Leche in St. Augustine, December 4 to 6, 2026. The full schedule, parking and what to bring are on [babystepscamino.com](https://babystepscamino.com/schedule-1).']
      ['landing.meter' s+'{{percent}}% of the full Camino is taken']
      ['landing.meter.hurry' s+'Spots are going fast.']
      ['landing.full.title' s+'The full Camino']
      ['landing.full.blurb' s+'Friday, Saturday and Sunday, December 4 to 6. About 10 miles a day along the beach, with Mass, a Holy Hour, and a social each afternoon. Walk all three days or any of them.']
      ['landing.full.who' s+'For anyone walking on Friday or Saturday, and for the 10 miles on Sunday.']
      ['landing.full.fee' s+'$75 per person, adults and children alike.']
      ['landing.full.button' s+'Register for the full Camino']
      ['landing.bambino.title' s+'The Bambino Camino']
      ['landing.bambino.blurb' s+'Sunday only: the last 2.5 miles from Vilano Beach to the Shrine of Our Lady of La Leche, walking from 11am after prayer.']
      ['landing.bambino.who' s+'Made for young children, grandparents and anyone who wants to finish the walk with us.']
      ['landing.bambino.fee' s+'$25 per person.']
      ['landing.bambino.button' s+'Register for the Bambino Camino']
      ['landing.choose' s+'Not sure? If you will walk on Friday or Saturday at all, choose the full Camino. On Sunday every full-Camino pilgrim may choose the 10 miles or the last 2.5.']
      ...
      ['form.sun' s+'Sunday, December 6: to the Shrine in St. Augustine']
      ['form.sun.ten' s+'10 miles from GTM Reserve']
      ['form.sun.short' s+'The last 2.5 miles from Vilano Beach (the Bambino route)']
      ['form.sun.bambino' s+'Sunday, December 6: the last 2.5 miles from Vilano Beach to the Shrine, 11am']
      ...
      ['form.saturday.title' s+'Saturday']
      ['form.saturday.closed' s+'Check Saturday to see Saturday\'s events']
      ...
      ['form.about.you' s+'About you']
      ['form.first_bsc' s+'This is {{name}}\'s first Baby Steps Camino']
      ['form.first_bsc.you' s+'This is my first Baby Steps Camino']
      ['form.knight_dame' s+'Knight or Dame of the Order of Malta']
      ['form.volunteer' s+'Volunteering at the event']
      ['form.contact.title' s+'How do we reach you?']
      ['form.contact.help' s+'Your confirmation, your link to make changes, and any news about the weekend go here.']
      ['form.email' s+'Email']
      ['form.phone' s+'Mobile phone']
      ['form.street' s+'Street address']
      ['form.city' s+'City']
      ['form.state' s+'State']
      ['form.zip' s+'ZIP']
      ['form.address.help' s+'Street, city, state and ZIP. We like to know how far our pilgrims travel.']
      ['form.org' s+'Parish, school or group (optional)']
      ['form.org.help' s+'If you are coming with others, name the group so we can keep you together in the counts.']
      ['form.why' s+'Why are you walking?']
      ['form.why.help' s+'A sentence or two is plenty. The organizers read every answer.']
      ...
      ['form.fees.title' s+'What it costs']
      ['form.fees.line' s+'{{name}} · {{what}}']
      ['form.fees.full' s+'full Camino']
      ['form.fees.bambino' s+'Bambino Camino']
      ['form.fees.child' s+'under 18']
      ['form.fees.total' s+'Total']
      ['form.fees.nonrefundable' s+'The registration fee is non-refundable. The full cost of a pilgrim\'s weekend is about $150; at payment you can choose to cover it.']
      ['form.submit' s+'Continue to the waiver']
      ['form.submit.waitlist' s+'Join the wait list']
      ['form.submit.room' s+'There is room on the {{track}} right now.']
      ['form.submit.full' s+'The {{track}} is full at the moment, so this registration joins the wait list.']
      ['track.full' s+'full Camino']
      ['track.bambino' s+'Bambino Camino']
      ['form.saving' s+'Saved']
      ...
      ['next.waitlist.body' s+'You are number {{position}} on the wait list for the {{track}}. We email as soon as a spot opens; in past years many have.']
      ['next.complete.title' s+'You are registered']
      ['next.complete.body' s+'See you on the beach, {{first}}. A confirmation is on its way to {{email}} with your link to change or cancel. Your weekend: {{summary}}']
      ['next.cancelled.title' s+'This registration is cancelled']
      ['next.cancelled.body' s+'Nothing is held for your party any more. If that was a mistake, you can register again from the start.']
      ['next.draft.title' s+'Your registration is not finished']
      ['next.draft.body' s+'Nothing is held until you sign the waiver. Open the link in your email to pick up where you left off.']
      ['manage.title' s+'Your registration']
      ['manage.line' s+'Registered {{created}}. Change anything below until {{cutoff}}, or cancel for the whole party.']
